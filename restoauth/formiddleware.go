...
//FormMiddleware for converting posted form data into json
type FormMiddleware struct{}

//MiddlewareFunc handler and return handler
func (mw *FormMiddleware) MiddlewareFunc(handler rest.HandlerFunc) rest.HandlerFunc {
...
func (mw *FormMiddleware) conversionError(w rest.ResponseWriter) {
